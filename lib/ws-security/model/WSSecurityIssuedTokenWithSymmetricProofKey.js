...
var template = readFileSync(
  join(__dirname, "/templates/WSSecurityIssuedTokenWithSymmetricProofKey.xml"),
  "utf-8"
);

class WSSecurityIssuedTokenWithSymmetricProofKey {
  constructor(opts) {
    var signingKey = calculatePSHA1(
      opts.clientEntropy,
      opts.serverEntropy,
      opts.keySize
    );
    ...
    var timestamp =
      '<u:Timestamp xmlns:u="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd" u:Id="_0"><u:Created>' +
      created +
      "</u:Created><u:Expires>" +
      expires +
    ...
    var signatureValue = createHmac("sha1", new Buffer(signingKey, "base64"))
      .update(signedInfo)
      .digest("base64");
...
export default WSSecurityIssuedTokenWithSymmetricProofKey;
