var Message = function (util) {
	...
	this.Disassociate = function (options) {
		...
		return util.executePostPromised(options, "Disassociate", template, body);
    };
	...
	this.Execute = function (options, cb) {
		...
		var body = serializer.toXmlExecute(options);

        return util.executePostPromised(options, "Execute", template, body);
    };
}
