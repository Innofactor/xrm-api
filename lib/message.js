class Message {
  constructor(util) {
    ...
    this.RetrieveMultiple = function(options) {
      ...
      return util.executePostPromised(
        options,
        "RetrieveMultiple",
        template,
        serializer.toXmlRetrieveMultiple(options)
      );
    };
    this.Retrieve = function(options) {
      ...
      return util.executePostPromised(
        ...
        "Retrieve",
        template,
        serializer.toXmlRetrieve(options)
      );
    };
    this.Create = function(options) {
      ...
      return util.executePostPromised(
        ...
        "Create",
        template,
        serializer.toXmlCreateUpdate(options)
      );
    };
    ...
    this.Delete = function(options) {
      ...
      return util.executePostPromised(
        ...
        "Delete",
        template,
        serializer.toXmlDelete(options)
      );
    };
    this.Associate = function(options) {
      ...
      return util.executePostPromised(
        ...
        "Associate",
        template,
        serializer.toXmlAssociate(options)
      );
    };
    ...
    this.Execute = function(options, cb) {
      ...
      return util.executePostPromised(
        ...
        "Execute",
        template,
        serializer.toXmlExecute(options)
      );
    };
  }
}
