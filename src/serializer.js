  ...
  constructor() {
    ...
    this.toXmlRetrieveMultiple = function(options) {
      ...
      if (options.ColumnSet) {
        ...
        xml +=
          '<b:ColumnSet><b:AllColumns>false</b:AllColumns><b:Columns xmlns:c="http://schemas.microsoft.com/2003/10/Serialization/Arrays">' +
          columset.join("") +
          "</b:Columns></b:ColumnSet>";
      }
      if (options.Criteria) {
        if (options.Criteria.Conditions) {

          const conditions = options.Criteria.Conditions
          .map((c) => {
            return `<b:ConditionExpression>
                      ...
                      <b:Values xmlns:c="http://schemas.microsoft.com/2003/10/Serialization/Arrays">
                        <c:anyType xmlns:d="http://www.w3.org/2001/XMLSchema" i:type="d:string">
                          ${c.Value}
                        </c:anyType>
                      </b:Values>
          ...
          if (options.Criteria.FilterOperators) {
            const filters = options.Criteria.FilterOperators
            .map((c) => {
      ...
      xml +=
        "<b:ReturnTotalRecordCount>false</b:ReturnTotalRecordCount></b:PageInfo>";
      return xml;
    };
